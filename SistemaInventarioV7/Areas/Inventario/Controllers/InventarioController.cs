...
namespace SistemaInventarioV7.Areas.Inventario.Controllers
{
    ...
    public class InventarioController : Controller
    {
        ...
        {
            //Inicializamos InventarioVM
            inventarioVM = new InventarioVM();
            //Llenamos la cabezera del inventario segun el InventarioId enviado
            inventarioVM.Inventario = await _unidadTrabajo.Inventario.ObtenerPrimero(i => i.Id == InventarioId);
            //Verificamo si existe el producto ya en un inventario
            ...
            //Si no existe lo actualizamos según la cantidad ingresada
            else
            {
                detalle.Cantidad += cantidadId;
                await _unidadTrabajo.Guardar();
            }
            //Redireccionamos al metodo DetalleInventario de mas arriba que recibe un parametro
